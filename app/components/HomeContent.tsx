...
import { Globe, MapPin, Zap, ShieldCheck, Phone, Plus, Minus, Star, Wind, Clock, Sparkles, Heart } from 'lucide-react'
    ...
    <div className="page-fade">
      ...
      <section className="relative min-h-[95vh] flex items-center px-6 overflow-hidden bg-white">
        ...
        <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-16 items-center relative z-10">
          <div className="space-y-10">
            ...
            <h1 className="text-5xl md:text-[70px] font-serif font-bold text-stone-900 leading-[1] tracking-tight text-balance">
              Le Souffle <br />
            ...
            <div className="flex flex-col sm:flex-row gap-5 pt-4">
              <Link href="/soin-photo" className="px-10 py-5 bg-indigo-600 text-white rounded-2xl font-bold text-lg hover:bg-indigo-700 transition-all btn-glow flex items-center justify-center gap-3 group shadow-xl">
          ...
          <div className="relative hidden md:flex flex-col items-center">
            ...
            <div className="aspect-[4/5] bg-stone-100 rounded-[5rem] overflow-hidden shadow-2xl relative group border-8 border-stone-50 w-full max-w-md">
              <Image
                ...
                alt="Energie a distance France - Jean-Francois magnetiseur"
                fill
      ...
      <section className="py-12 bg-indigo-600 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_center,_white_0%,_transparent_100%)]"></div>
        </div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { name: "Sophie M.", city: "Lyon (69)", text: "Jean-Francois m'a aide pour un zona tres douloureux. En deux seances a distance, le feu s'est eteint." },
              { name: "Marc D.", city: "Paris (75)", text: "Mes douleurs de dos chroniques ont disparu apres l'envoi de ma photo. Un vrai soulagement." },
              { name: "Thomas R.", city: "Nantes (44)", text: "Brulure domestique grave, Jean-Francois a 'coupe le feu' immediatement a distance." },
              { name: "Julie V.", city: "Strasbourg (67)", text: "Ma fille souffrait d'un eczema tenace. Son soin sur photo a ete fulgurant." },
              { name: "Frederic L.", city: "Bordeaux (33)", text: "Soin a distance pour une douleur a l'epaule qui trainait depuis des mois. Le resultat est bluffant." },
              { name: "Sandrine K.", city: "Nice (06)", text: "Une seance sur photo pour mon fils qui faisait des cauchemars. Depuis, ses nuits sont paisibles." },
              { name: "Alain P.", city: "Lille (59)", text: "Je recommande vivement Jean-Francois pour son efficacite sur les brulures. Un vrai coupeur de feu." },
              { name: "Isabelle B.", city: "Toulouse (31)", text: "Mon eczema s'est apaise des la premiere connexion. Merci pour cette aide precieuse." }
            ].map((t, i) => (
      ...
      <section className="py-20 bg-stone-950 text-white/40">
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-[10px] font-bold uppercase tracking-[0.4em] mb-12 text-center text-indigo-500">Rayonnement energetique national</p>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {["Paris", "Lyon", "Marseille", "Toulouse", "Nice", "Nantes", "Montpellier", "Strasbourg", "Bordeaux", "Lille", "Rennes", "Reims", "Toulon", "Saint-Etienne", "Le Havre", "Grenoble", "Dijon", "Angers", "Villeurbanne", "Alencon", "Brest", "Le Mans", "Amiens", "Limoges"].map(city => (
      ...
      <section className="py-24 bg-indigo-600 text-white overflow-hidden relative">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center space-y-10 relative z-10">
          <h2 className="text-4xl md:text-5xl font-serif font-bold italic text-balance">{"Pret a retrouver votre equilibre ?"}</h2>
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Link href="/soin-photo" className="px-12 py-6 bg-white text-indigo-600 rounded-3xl font-bold text-xl hover:shadow-2xl transition-all">Soin a distance immediat</Link>
          </div>
