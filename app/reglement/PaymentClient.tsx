    ...
    <div className="max-w-4xl mx-auto p-6 md:p-12 page-fade">
      <div className="text-center space-y-6 mb-16">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-50 border border-amber-100 rounded-full text-amber-700 text-[10px] font-bold uppercase tracking-widest">
          <Sparkles size={12} /> Equilibre & Gratitude
        </div>
        <h1 className="text-5xl md:text-6xl font-serif font-bold text-stone-900 leading-tight text-balance">
        ...
        <p className="text-xl text-stone-500 max-w-2xl mx-auto font-light leading-relaxed">
          {"Le soin est un echange d'energie. Votre participation permet de soutenir mon travail et de maintenir cet espace d'accompagnement pour tous."}
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-stretch">
        <div className="bg-white rounded-[3.5rem] p-10 border border-stone-100 shadow-xl space-y-8 flex flex-col">
          <div className="space-y-4">
            <h2 className="text-2xl font-serif font-bold text-stone-900">Le Don Libre</h2>
            <p className="text-stone-500 text-sm leading-relaxed">
              {"Il n'y a pas de tarif impose pour le souffle. Je laisse chacun libre de contribuer selon ses moyens et son ressenti apres le soin ou lors de la demande."}
            </p>
          </div>
          ...
          <div className="flex-1 space-y-4">
            <div className="flex items-start gap-4 p-4 bg-stone-50 rounded-2xl">
              ...
              <div>
                <p className="text-sm font-bold text-stone-800">Soin a distance</p>
                <p className="text-xs text-stone-500">Action immediate apres reception de la photo.</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-4 bg-stone-50 rounded-2xl">
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-indigo-600 shadow-sm shrink-0">
              ...
              <div>
                <p className="text-sm font-bold text-stone-800">Paiement Securise</p>
        ...
        <div className="bg-stone-900 rounded-[3.5rem] p-10 text-white space-y-8 flex flex-col relative overflow-hidden">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-serif font-bold italic">Pourquoi participer ?</h2>
            <p className="text-stone-400 leading-relaxed">
              Chaque soin demande une preparation, une connexion profonde et un suivi energetique sur plusieurs jours.
              Votre participation assure la perennite de ce service de soin a distance dans toute la France.
            </p>

            <div className="pt-6 space-y-4">
              <div className="flex items-center gap-3 text-stone-300">
                <div className="w-1.5 h-1.5 bg-indigo-500 rounded-full"></div>
                <span className="text-sm">{"Materiel & Support technique"}</span>
              </div>
              <div className="flex items-center gap-3 text-stone-300">
                <div className="w-1.5 h-1.5 bg-indigo-500 rounded-full"></div>
          ...
          <div className="mt-auto pt-10">
            <div className="p-6 bg-white/5 rounded-3xl border border-white/10 italic text-stone-400 text-sm">
              {"\"L'argent est un outil de circulation de l'energie. Donnez ce qui vous semble juste.\""}
            </div>
          </div>
        </div>
      </div>
