...
import { Menu, X, Phone, Heart, MessageCircle, Home, LayoutDashboard, CreditCard, Clock, Mail, MapPin, BookOpen, User, Sparkles } from 'lucide-react'
...
const navItems = [
  ...
  { id: '/bilan-energetique', label: 'Bilan 3D', icon: Sparkles },
